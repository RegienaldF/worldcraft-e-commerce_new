...
@section('links')
<link rel="stylesheet" href="{{ asset('assets/css/order_confirmed_style.css') }}">
@endsection

@section('content')

<section class="py-5 bg-lightblue" style="background: rgb(242, 245, 250) !important;">
    <div class="container">
        ...
        @php
            $order_count = 0;
            $orders = \App\Models\Order::where('id',56734)->get();
        @endphp
        ...
        @endforeach
        <div class="d-flex mb-5 mt-5" style="justify-content:center;">
