        ...
        <div class="container">
            ...
            @php
                ...
                try {
                    ...
                    $pscs = [];
                    $psc_accounts = \App\User::where('is_psc', 1)->select('email')->get()->pluck('email')->toArray();
                }
                catch(\Throwable $th) {
                    $pscs = [$th->getMessage()];
                    //     $psc_accounts = [
                ...
                <div class="text-left">
                    <div class="row">
                        <div class="col-xxl-8 col-xl-8 mx-auto">
                            <form class="form-default" action="" method="post" id="checkout-form">
                                @csrf
                                {{-- HIDDEN INPUTS --}}
                                                                    ...
                                                                    {{-- <div class="col-md-12">
                                                                        <div class="form-craft-radio">
                                                                            <label for="credit_card" class="pt-3 text-paragraph-thin c-pointer">
                                                                                <input type="radio" id="credit_card" name="payment_channel" value="credit_card"  style="height: 11px;">
                                                                                <img style="max-width: 55px;" src="{{ static_asset('assets/img/mastercard-visa.png') }}" class="pl-3 px-2" alt="">
                                                                                Mastercard / VISA
                                                                            </label>
                                                                        </div>
                                                                    </div> --}}
                                                ...
                                                @if(DB::table('addons')->where('unique_identifier','mpgs')->first()->version == 1)
                                                    ...
                                                    <div class="form-craft-radio">
                                                        <label for="credit_card" class="pt-3 text-paragraph-thin c-pointer">
                                                            ...
                                                            {{-- <img style="max-width: 100px;" src="{{ static_asset('assets/img/mastercard-visa.png') }}" class="pl-3 px-2" alt=""> --}}
                                                            {{-- Mastercard / VISA --}}
                                                        </label>
                                                    </div>
                                                    <hr class="my-2">
                            ...
                            <label for="agree_checkbox" class="form-craft-check d-flex align-items-center">
                                ...
                                <span class="d-flex text-craft-sub ml-2" style="font-size:14px;">
                                    <span class="mr-1 ml-2">
                                        ...
                                        <a class="link-blue" href="#" target="_blank">
                ...
                <form id="termsAndConditionsForm" onsubmit="return validateCheckbox()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="#" type="button" class="btn btn-secondary"><i class="las la-arrow-left"></i> Back to Shipping</a>
